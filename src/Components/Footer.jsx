...
const Footer = () => {
  ...
  return (
   <footer className="fixed bottom-0 w-full px-2 z-50 shadow-lg backdrop-blur bg-white/0">

      {/* Mobile Layout */}
     <div className="sm:hidden flex flex-col items-center gap-2 px-4 py-3 text-center text-xs">
